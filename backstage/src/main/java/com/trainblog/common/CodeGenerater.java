...
public class CodeGenerater {
    ...
    public static void main(String[] args) {
        ...
        String projectPath = System.getProperty("user.dir")+"/backstage";
        ...
        //
        dsc.setUrl("jdbc:mysql://localhost:3306/trainblog?useUnicode=true&characterEncoding=UTF8&useSSL=false");
